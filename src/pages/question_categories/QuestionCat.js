...
function question_categories() {
    ...
    const switchTab = (tab) => {
        setActiveTab(tab);
        navigate("/page/questioncategory?page=" + tab);
    };
        ...
        <>
            <CTabs activeItemKey={activeTab}>
                <CTabList style={{ float: "right" }} variant="pills">
                    <CTab itemKey="list" onClick={() => switchTab("list")} style={tabStyle(activeTab === 'list')}>List</CTab>
                    <CTab itemKey="manage" onClick={() => switchTab("manage")} style={tabStyle(activeTab === 'manage')}>Manage</CTab>
                </CTabList>
            </CTabs> <br/><br/>
            <CTabContent>
